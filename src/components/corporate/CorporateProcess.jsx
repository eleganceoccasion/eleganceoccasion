...
import { CORPORATE_PROCESS } from "@/data/weddings";
import Reveal from "@/components/site/Reveal";

// Brief-led engagement, shown as a three-step timeline — how a corporate
// booking moves from objectives to a clean pack-down.
export default function CorporateProcess() {
  return (
    <section className="bg-surface">
      <div className="mx-auto max-w-site px-6 py-20 lg:px-8 lg:py-28">
        <Reveal>
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-gold">How we engage</p>
          <h2
          ...
          >
            Brief-led, from first call to clean pack-down.
          </h2>
        </Reveal>

        <div className="mt-12 grid gap-x-8 gap-y-10 sm:grid-cols-3">
          {CORPORATE_PROCESS.map((s, i) => (
